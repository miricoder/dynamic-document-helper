...
def main():
    ...
    api_key = st.sidebar.text_input(
        ...
        key="api_key",
        value=st.session_state.api_key_state["value"],
    )
    ...
    if st.session_state.get("api_key_validated", False):
        ...
        website_link = st.text_input(
            "Enter Website Link for Web Scraping:",
            key="website_link",
            value=st.session_state.website_link_state["value"],
        )
        ...
        new_chat_prompt = st.text_input(
            "Prompt",
            key="new_chat_prompt",
            value=st.session_state.new_chat_prompt_state["value"],
